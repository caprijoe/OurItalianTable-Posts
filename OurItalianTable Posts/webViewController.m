...
@property (nonatomic,strong) UIPopoverController *detailPopover;     // the info popover, if on screen
@property (nonatomic,strong) UIPopoverController *locationPopover;  // the location popover, if on screen
@end
